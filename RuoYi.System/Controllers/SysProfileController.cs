...
namespace RuoYi.System.Controllers
{
    ...
    public class SysProfileController : ControllerBase
    {
        ...
        public async Task<object> UploadAvatar([Required] IFormFile avatarfile)
        {
            if (avatarfile != null)
            {
                LoginUser loginUser = SecurityUtils.GetLoginUser();
                string avatar = await FileUploadUtils.UploadAsync(avatarfile, RyApp.RuoYiConfig.AvatarPath, MimeTypeUtils.IMAGE_EXTENSION);
